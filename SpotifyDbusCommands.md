# Introduction #
These are the commands that are exposed the spotify dbus interface. Run them with
```
dbus-send --dest=org.mpris.MediaPlayer2.spotify /org/mpris/MediaPlayer2 COMMAND
```
# Commands #
